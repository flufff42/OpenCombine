...
extension Publishers.Buffer {
        ...
        where Downstream.Input == Upstream.Output, Downstream.Failure == Upstream.Failure
    {
        ...
        func request(_ demand: Subscribers.Demand) {
            ...
            subscription.request(drain() + demand) // TODO: Test this (including .none)
        }
        ...
        private func drain() -> Subscribers.Demand {
            ...
            while true {
                ...
                downstreamDemand -= poppedValues.count // TODO: Can we make this crash?
        ...
        private func lockedPop(_ demand: Subscribers.Demand) -> [Input] {
            demand.assertNonZero() // TODO: Test this assertion
